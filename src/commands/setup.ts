...
const BRAINMELD_GRAPH_CSS = `/* ClawVault Graph Colors — BrainMeld Neural Style */
/* Auto-generated by \`clawvault setup --theme brainmeld\` */
...
function writeGraphColors(vaultPath: string, theme: string, force: boolean): boolean {
  ...
  // Write CSS snippet
  const css = theme === 'brainmeld' ? BRAINMELD_GRAPH_CSS : MINIMAL_GRAPH_CSS;
  ...
  graphConfig.colorGroups = theme === 'brainmeld' ? BRAINMELD_COLOR_GROUPS : MINIMAL_COLOR_GROUPS;
  if (theme === 'brainmeld') {
...
export async function setupCommand(options: SetupOptions = {}): Promise<void> {
  ...
  const theme = options.theme ?? 'brainmeld';
  ...
  console.log('\nCustomize further:');
  console.log('  clawvault setup --theme brainmeld     # BrainMeld neural graph colors');
